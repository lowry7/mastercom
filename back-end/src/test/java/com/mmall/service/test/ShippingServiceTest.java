...
public class ShippingServiceTest extends TestBase {
	...
	/*
	 * @Test public void testSelect(){ ServerResponse sr =
	 * iShippingService.select(1, 3); Shipping shipping = (Shipping)sr.getData();
    ...
    public void testList(){
        ...
        ServerResponse x = ServerResponse.createBySuccess(sr.getData());
